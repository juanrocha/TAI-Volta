...
```{r crops_32, eval = TRUE, echo=FALSE, cache=TRUE, fig.height=7, fig.width=7, collapse=TRUE, fig.align='center', fig.show='hold', error=FALSE, warning=FALSE, message=FALSE}
...
```{r echo=FALSE, cache=TRUE, collapse=TRUE, fig.align='center', fig.show='hold', error=FALSE, warning=FALSE, message=FALSE}
...
```{r echo = FALSE, cache=TRUE,  collapse=TRUE, cache=TRUE, fig.align='center', fig.height=5, fig.width=7, fig.show='hold', error=FALSE, warning=FALSE, message=FALSE}
